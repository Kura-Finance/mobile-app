# Contributor Covenant Code of Conduct / 貢獻者公約
...
- Focusing on what is best for the community and the security of users
...
- Publishing exploit details before coordinated disclosure ([SECURITY.md](SECURITY.md))
...
This Code of Conduct applies within all community spaces — GitHub issues, pull requests, discussions, and official communication channels — and also applies when an individual is officially representing the project in public spaces.

### Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to **conduct@kura-finance.com** or **security@kura-finance.com** if safety-related.
...
- 骚扰、人身攻击、歧视性言论  
- 未经同意公开他人隐私  
- 在协调披露前公开漏洞利用细节（见 [SECURITY.md](SECURITY.md)）  
- 其他在专业场合不当的行为  

### 适用范围

GitHub Issue、PR、讨论及官方渠道；代表项目公开活动时同样适用。

### 举报

发送至 **conduct@kura-finance.com**（安全相关可同时抄送 **security@kura-finance.com**）。维护者将及时、公正处理并保护举报人隐私。
