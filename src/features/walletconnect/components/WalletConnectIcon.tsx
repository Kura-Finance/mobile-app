...
export default function WalletConnectIcon({ size = 18, color = '#3B99FC' }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d={WC_PATH} fill={color} />
    </Svg>
  );
}
